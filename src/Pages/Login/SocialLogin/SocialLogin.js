...
<div >
          ...
          <button className="btn btn-dark w-100 my-2" onClick={()=>signInWithGoogle()}>
          
          <img src={googleImg} className="me-2" style={{width:"25px" }} alt=""/>
          Sign in</button>
          <button className="btn btn-dark w-100 my-2">
          
          <img src={fbImg} className="me-2" style={{width:"25px" }} alt=""/>
         Facebook Sign in</button>
          <button className="btn btn-dark w-100 my-2" onClick={()=>signInWithGithub()}>
